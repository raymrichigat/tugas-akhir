...
Dari graf utuh tersebut dibentuk proyeksi jaringan antar tokoh peserta peristiwa sebanyak 137 *node* (tokoh nasab-only dibuang sesuai pembatasan cakupan di atas) sebagai dasar analisis sentralitas dan komunitas. Statistik tingkat graf (G5) proyeksi ini ditunjukkan pada Tabel 4.17.
...
**Studi kasus lima peristiwa besar (G6).** Untuk memvalidasi pipeline secara kualitatif, dipilih lima peristiwa dari periode yang berjauhan (P8 sampai P13) lalu diperiksa sub-grafnya. Ringkasannya ditunjukkan pada Tabel 4.23 dan panel visualisasinya pada Gambar 4.19.
